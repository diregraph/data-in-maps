...
export function MapDiagram({
  ...
  return (
    ...
    >
      ...
      <g
        onClick={() => onNodeClick("use-map-instance")}
        style={groupOpacity("use-map-instance", 1)}
      >
        <rect
          x="28"
          y="240"
      ...
      {/* ── Row 3: useFlyTo ── */}
      <g
        onClick={() => onNodeClick("use-fly-to")}
        style={groupOpacity("use-fly-to", 1)}
      >
        <rect
          x="246"
          y="240"
      ...
      {/* ── Row 3: useLayerSync ── */}
      <g
        onClick={() => onNodeClick("use-layer-sync")}
        style={groupOpacity("use-layer-sync", 1)}
      >
        <rect
          x="462"
          y="240"

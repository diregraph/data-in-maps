...
export function TileProviderDiagram({
  onNodeClick,
  activeNodeId,
  pendingNodeId,
}: TileProviderDiagramProps) {
  ...
  return (
    ...
    >
      ...
      {/* ── Row 1: map-canvas ── */}
      <g
        onClick={() => onNodeClick("map-canvas")}
        style={groupOpacity("map-canvas", 1)}
      >
        <rect
          x="220"
          y="20"
      ...
      <g
        onClick={() => onNodeClick("tile-provider-interface")}
        style={groupOpacity("tile-provider-interface", 1)}
      >
        <rect
          x="170"
          y="96"
      ...
      {/* ── Row 3: providers ── */}
      <g
        onClick={() => onNodeClick("pmtiles-provider")}
        style={groupOpacity("pmtiles-provider", 1)}
      >
        <rect
          x="28"
          y="196"
      ...
      <g
        onClick={() => onNodeClick("osm-provider")}
        style={groupOpacity("osm-provider", 1)}
      >
        <rect
          x="248"
          y="196"
      ...
      <g
        onClick={() => onNodeClick("mapbox-provider")}
        style={groupOpacity("mapbox-provider", 1)}
      >
        <rect
          x="468"
          y="196"
      ...
      <g
        onClick={() => onNodeClick("create-tile-provider")}
        style={groupOpacity("create-tile-provider", 1)}
      >
        <rect
          x="200"
          y="290"

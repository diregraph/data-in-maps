...
export function ExportDiagram({
  ...
  return (
    ...
    >
      ...
      {/* ── Row 1: ExportPanel ── */}
      <g
        onClick={() => onNodeClick("export-panel")}
        style={groupOpacity("export-panel", 1)}
      >
        <rect
          x="190"
          y="28"
      ...
      <path
        d="M 490 50 L 628 50 L 628 336 L 490 336"
        {...connectorProps}
        strokeDasharray="4 3"
      />
      ...
      {/* ── Row 2: useExport ── */}
      <g
        onClick={() => onNodeClick("use-export")}
        style={groupOpacity("use-export", 1)}
      >
        <rect
          x="190"
          y="100"
      ...
      {/* ── Row 3: png-exporter ── */}
      <g
        onClick={() => onNodeClick("png-exporter")}
        style={groupOpacity("png-exporter", 1)}
      >
        <rect
          x="28"
          y="200"
      ...
      {/* ── Row 3: svg-exporter ── */}
      <g
        onClick={() => onNodeClick("svg-exporter")}
        style={groupOpacity("svg-exporter", 1)}
      >
        <rect
          x="246"
          y="200"
      ...
      {/* ── Row 3: embed-link ── */}
      <g
        onClick={() => onNodeClick("embed-link")}
        style={groupOpacity("embed-link", 1)}
      >
        <rect
          x="464"
          y="200"
      ...
      {/* ── Row 4: api-route ── */}
      <g
        onClick={() => onNodeClick("api-route")}
        style={groupOpacity("api-route", 0.8)}
      >
        <rect
          x="190"
          y="308"

...
export function AppRouterDiagram({
  onNodeClick,
  activeNodeId,
  pendingNodeId,
}: AppRouterDiagramProps) {
  ...
  return (
    ...
    >
      ...
      {/* ── Row 1: layout ── */}
      <g
        onClick={() => onNodeClick("layout")}
        style={groupOpacity("layout", 1)}
      >
        <rect
          x="240"
          y="20"
      ...
      <g
        onClick={() => onNodeClick("map-group")}
        style={groupOpacity("map-group", 1)}
      >
        <rect
          x="30"
          y="104"
      ...
      <g
        onClick={() => onNodeClick("marketing-group")}
        style={groupOpacity("marketing-group", 1)}
      >
        <rect
          x="250"
          y="104"
      ...
      <g
        onClick={() => onNodeClick("map-page")}
        style={groupOpacity("map-page", 1)}
      >
        <rect
          x="18"
          y="200"
      ...
      <g
        onClick={() => onNodeClick("maps-id")}
        style={groupOpacity("maps-id", 1)}
      >
        <rect
          x="130"
          y="200"
      ...
      <g
        onClick={() => onNodeClick("marketing-page")}
        style={groupOpacity("marketing-page", 1)}
      >
        <rect
          x="238"
          y="200"
      ...
      <g
        onClick={() => onNodeClick("ai-route")}
        style={groupOpacity("ai-route", 1)}
      >
        <rect
          x="456"
          y="200"
      ...
      <g
        onClick={() => onNodeClick("export-route")}
        style={groupOpacity("export-route", 1)}
      >
        <rect
          x="572"
          y="200"
      ...
      {/* ── Row 4: special files ── */}
      <g
        onClick={() => onNodeClick("loading")}
        style={groupOpacity("loading", 1)}
      >
        <rect
          x="28"
          y="296"
      ...
      <g
        onClick={() => onNodeClick("not-found")}
        style={groupOpacity("not-found", 1)}
      >
        <rect
          x="280"
          y="296"
      ...
      <g
        onClick={() => onNodeClick("opengraph-image")}
        style={groupOpacity("opengraph-image", 1)}
      >
        <rect
          x="416"
          y="296"
      ...
      <g
        onClick={() => onNodeClick("sitemap")}
        style={groupOpacity("sitemap", 1)}
      >
        <rect
          x="552"
          y="296"
